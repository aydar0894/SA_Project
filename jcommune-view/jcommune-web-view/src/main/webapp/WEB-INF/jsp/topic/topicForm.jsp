...
<head>
  ...
  <title>
    ...
    <c:if test="${topicDto.topic.branch.name != null}"><c:out value="${topicDto.topic.branch.name}"/> - </c:if><spring:message code="h.new_topic"/>
  </title>
...
<div class="container">
  ...
  <form:form action="${pageContext.request.contextPath}${submitUrl}"
    ...
    <div class='control-group hide-on-preview'>
      <div class='controls'>
        ...
        <form:input path="topic.title" id="subject" type="text" size="45"
                    maxlength="255" tabindex="100" oninput="search()"
    ...
    <h1 id="result_status" class="alert alert-info hidden" role="alert"></h1>
    <div id="result" >
