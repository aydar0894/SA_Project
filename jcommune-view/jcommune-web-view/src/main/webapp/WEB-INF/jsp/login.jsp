...
<div class="container form-login-related">
    <form:form id="login-form" name="form" action='${pageContext.request.contextPath}/login'
        ...
        <fieldset>
            ...
            <div class="control-group">
                <label class="rememberme-lbl"><input type="checkbox" name="_spring_security_remember_me"
                                                     class="form-check-radio-box" checked="checked"><spring:message
                        code="label.auto_logon"/></label>
            </div>

            <div class="control-group">
                <a href="/facebook/sign_in" id="facebook-login" class="btn btn-primary">Log in via facebook</a>
                <br/>
            ...
            <div class="form-actions">
                <input type="submit" id="page-signin-submit-button" class="btn btn-primary"
