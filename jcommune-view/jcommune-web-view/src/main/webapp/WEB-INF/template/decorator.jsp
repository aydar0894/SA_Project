...
<head>
  ...
  <c:choose>
    <c:when test="${mode eq 'true'}">
      <link rel="stylesheet" type="text/css" media="screen"
            href="${pageContext.request.contextPath}/resources/compressed/css/main.css?${project.version}"/>

      <script src="${pageContext.request.contextPath}/resources/compressed/javascript/main.js?${project.version}"></script>
      ...
      or fn:contains(uriString, 'quote')}">
        <script language="javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/pm.js?${project.version}"></script>
      </c:if>

      <c:if test="${fn:contains(uriString, 'posts')}">
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/post.js?${project.version}"></script>
      </c:if>

      <c:if test="${fn:contains(uriString, 'reviews')}">
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/cr.js?${project.version}"></script>
      </c:if>

      <c:if test="${fn:contains(uriString, 'user')}">
        <link rel="stylesheet" type="text/css" media="screen"
              href="${pageContext.request.contextPath}/resources/compressed/css/user.css?${project.version}"/>

        <script type="text/javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/user.js?${project.version}"></script>
      </c:if>

      <c:if test="${fn:contains(uriString, 'users')}">
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/users.js?${project.version}"></script>
      </c:if>

      <c:if test="${fn:contains(uriString, 'plugins')}">
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/plugin.js?${project.version}"></script>
      </c:if>

      <c:if test="${fn:contains(uriString, 'topics') or fn:contains(uriString, 'branches')}">
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/topic.js?${project.version}"></script>
      </c:if>
      <c:if test="${fn:contains(uriString, 'topics') and not fn:contains(uriString, 'new') and not fn:contains(uriString, 'edit')}">
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/postDraft.js?${project.version}"></script>
      </c:if>
      <c:if test="${(fn:contains(uriString, 'topics') or fn:contains(uriString, 'reviews')) and fn:contains(uriString, 'new')}">
        <script type="text/javascript"
                src="${pageContext.request.contextPath}/resources/compressed/javascript/topicDraft.js?${project.version}"></script>
      </c:if>
    </c:when>
  ...
  <footer>
    ...
    <div>
      <div class="pull-left">
        ...
        Powered by JCommune ${project.version} by <a class="space-left-small"
                                                     href="http://jtalks.org">jtalks.org</a><br/>
